...
<div style="background-color:#a64dff;margin-top:-30px;">
    <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card border-0"  style="margin-top:80px;margin-bottom:50px;">
                        <div class="card-body">
                            <form method="POST" action="{{ route('login') }}">
                                @csrf
                                <div class="row p-0 m-0">
                                    <div class="col-4">
                                        <img src="https://images.unsplash.com/photo-1510861320402-285a6c7639ea?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" style="height: 400px; padding: 0px; margin-left: -35px;margin-top: -20px;margin-bottom: -20px;">
                                    </div>
